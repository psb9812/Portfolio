...
//
//---------------------------------------------------------------
struct SC_CREATE_MY_CHARACTER_PACKET
{
	unsigned int id;
...
//
//---------------------------------------------------------------
struct SC_CREATE_OTHER_CHARACTER_PACKET
{
	unsigned int id;
	unsigned char direction;
	short x;
...
//
//---------------------------------------------------------------
struct SC_DELETE_CHARACTER_PACKET
{
	unsigned int id;
};
