...
#define MONITOR_TOOL_SESSION_KEY "ajfw@!cv980dSZ[fje#@fdj123948djf"
...
enum en_PACKET_TYPE
{
	...
	*
	...
	//
	//------------------------------------------------------------
	en_PACKET_CS_CHAT_REQ_USER_DISTRIBUTION,
	...
	//
	//------------------------------------------------------------
	en_PACKET_CS_CHAT_RES_USER_DISTRIBUTION,
	...
	//
	// 서버의 다운 및 기타 이유로 모니터링 데이터가 전달되지 못할 떄를 대비하여 TimeStamp 를 전달한다.
...
enum en_PACKET_SS_MONITOR_DATA_UPDATE
{
	...
	dfMONITOR_DATA_TYPE_CHAT_UPDATE_TPS = 35,			// 채팅서버 UPDATE 스레드 초당 처리 횟수
