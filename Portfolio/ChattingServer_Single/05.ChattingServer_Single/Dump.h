...
public:
	Dump()
	{
		...
		_CrtSetReportMode(_CRT_WARN, 0);								//CRT 오류 메시지 표시 중단. 바로 덤프 남도록 유도
		_CrtSetReportMode(_CRT_ASSERT, 0);								//CRT 오류 메시지 표시 중단. 바로 덤프 남도록 유도
		_CrtSetReportMode(_CRT_ERROR, 0);								//CRT 오류 메시지 표시 중단. 바로 덤프 남도록 유도
